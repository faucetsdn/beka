...
long_description = """
    Beeper is a fairly basic BGP speaker. It can send
    ...
    More information at https://github.com/samrussell/beeper
"""
...
setup(
    ...
    version='0.1.0',
    url='https://github.com/samrussell/beeper',
    author='Sam Russell',
    ...
    keywords='bgp beeper routing sdn networking',
    packages=['beeper'],
    python_requires='>=3',
    install_requires=[
        'eventlet'
